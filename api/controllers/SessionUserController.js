...
module.exports = {
	...
	findUsersBySession1: function(req, res){
		//console.log(req);
		var session_id = req.param('session_id');
		//console.log('session_id: ' + session_id);
		SessionUser.query(
				'select u.*, n.ngo as ngo1, n2.ngo as ngo2 from uzer u, sessionuser su, ngo_choice1 n, ngo_choice3 n2 where ' +
	...
	findUsersBySession2: function(req, res){
		//console.log(req);
		var session_id = req.param('session_id');
		//console.log('session_id: ' + session_id);
		SessionUser.query(
